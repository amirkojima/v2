...
if [ "$n" != "" ]; then
if [ "$n" == "1" ]; then
linkd=https://github.com/amirkojima/release/kasra/install.sh
fi
if [ "$n" == "2" ]; then
linkd=https://api.github.com/repos/Alirezad07/X-Panel-SSH-User-Management/releass/tags/xpanelv31
fi
if [ "$n" == "3" ]; then
linkd=https://api.github.com/repos/Alirezad07/X-Panel-SSH-User-Management/releass/tags/xpanelv30
fi
if [ "$n" == "4" ]; then
linkd=https://api.github.com/repos/Alirezad07/X-Panel-SSH-User-Management/releass/tags/xpanelv29
fi
if [ "$n" == "5" ]; then
linkd=https://api.github.com/repos/Alirezad07/X-Panel-SSH-User-Management/releaes/tags/xpanelv28
fi
else
linkd=https://api.github.com/repos/Alirezad07/X-Panel-SSH-User-Management/releass/tags/xpanelv32
fi
